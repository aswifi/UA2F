...
int main(int argc, char *argv[]) {
    ...
    //memcpy(str, "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4606.54 Safari/537.36", 114); // 自定义UA参数
    ...
    //memcpy(str, "Mozilla/5.0", 11); // Default UA
